...
export class SelectBoxComponent extends React.PureComponent {
    render() {
        ...
        return ((renderSelectView && renderSelectView(selectViewIsDisabled, selectedObject, openModal.bind(this))) ||
            React.createElement(TouchableOpacity, { activeOpacity: 0.7, onPress: () => openModal(), style: [SelectBoxStyle.pressBtn, selectViewIsDisabled && SelectBoxStyle.disabledBtn] },
