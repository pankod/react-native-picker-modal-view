...
| **onSelected** <br> **required* | `Function`  | Returns selected item object | ```json { Id: string | number, Name: string, Value: string, [key: string]: any}``` 			| 
| **items** <br> **required* | `array`  | Array of list items | ```json [{ Id: string | number, Name: string, Value: string, [key: string]: any}]``` 		| 
